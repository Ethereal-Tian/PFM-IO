function img = loadPFM(filePath)
    ...
    %Line 1: The text 'PF' or 'Pf' where the latter denotes grayscale and the former denotes 3 channel color.
    ...
    %    |S| is a scale factor to relate pixel samples to a physical quantity(like radiance for example).
